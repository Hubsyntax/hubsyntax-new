...
export default function KickProject() {
  ...
  useEffect(() => {
    ...
    gsap.utils.toArray(".project-approch").forEach((el, index) => {
      ...
      if (icon) icon.style.borderColor = "#F2F2F2";
      ...
      ScrollTrigger.create({
        ...
        onUpdate: (self) => {
          ...
          if (self.progress > 0.5) {
            ...
            if (icon) icon.style.borderColor = "#FF3E5E";
        ...
        onEnter: () => {
          gsap.fromTo(el, { opacity: 0.2 }, { opacity: 1, duration: 1 });
        },
  ...
  return (
    <section className='bg-[#fff5f7] py-[150px] section-kick-project'>
