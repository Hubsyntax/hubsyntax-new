...
export default function ServicesMain() {
    ...
    return (
        <section className="bg-white pt-[120px] pb-[150px] relative service-section">
            ...
            <div className='side-bg-left absolute bottom-[2%] left-[-22%]'>
                <img src='https://hubsyntax.com/uploads/Element (1).svg' alt="Logo" className="w-auto" />
            </div> */}

            <div className="container mx-auto flex gap-[100px] items-start service-section">
