    ...
    return (
        <section className="footer bg-[#00293f] pt-[70px]  text-white w-full max-w-[100%] relative overflow-hidden">
            ...
            "
                ...
                "
                    >
                        <li className="list-none cursor-pointer hover:text-[#FF3E5E]">Home</li>
                        <li className="list-none cursor-pointer hover:text-[#FF3E5E]">Services</li>
                        <li className="list-none cursor-pointer hover:text-[#FF3E5E]">Portfolio</li>
                        <li className="list-none cursor-pointer hover:text-[#FF3E5E]">About Us</li>
                    </div>
